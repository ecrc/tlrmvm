...
namespace cudatlrmvm
{
    ...
    {
    public:
        explicit TlrmvmMPfp16(TlrmvmConfig tlrmvmconfig);
        TlrmvmMPfp16();
        ...
        CUDAPhasePointers<cuHalfComplex> cudap1ptrs;
        CUDAPhasePointers<cuHalfComplex> cudap1transptrs;
        CUDAPhasePointers<cuHalfComplex> cudap3ptrs;
        CUDAPhasePointers<cuHalfComplex> cudap3transptrs;
