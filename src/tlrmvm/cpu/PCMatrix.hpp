...
public:
    ...
    PCMatrix(string acc, int nb, int constranksize, int originM, int originN);
    ...
    Matrix<T> Phase2();
    Matrix<T> Phase3();
    Matrix<T> Phase1Transpose();
    Matrix<T> Phase2Transpose();
    Matrix<T> Phase3Transpose();
...
public:
    ...
    FPPCMatrix(string acc, int nb, int constranksize, int originM, int originN);
    void LoadData();
...
public:
    ...
    CFPPCMatrix(string acc, int nb, int constranksize, int originM, int originN);
    void LoadData();
